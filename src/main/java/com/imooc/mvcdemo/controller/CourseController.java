...
public class CourseController {
	...
	public String viewCourses(@RequestParam("courseId") Integer courseId, Model model) {
	...
	public String viewCourses2(@PathVariable("courseId") Integer courseId, Map<String, Object> model) {
	...
	public String viewCourses3(HttpServletRequest request) {
